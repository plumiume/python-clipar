        ...
        **options: Unpack[NamespaceOptions]
        ...
        Args:
            namespace_type (type[NS] | None): The type of the namespace class to be wrapped.
                If `None`, returns a new :class:`NamespaceWithOptions` with updated options.
            ...
            add_help (bool): Whether to add a default help argument (default: :code:`True`).
                When True, automatically adds -h/--help options.

            allow_abbrev (bool): Whether to allow abbreviations of long options
                (default: :code:`True`). When True, '--verb' can match '--verbose'.

            exit_on_error (bool): Whether to exit on error (default: :code:`True`).
            ...
            suggest_on_error (bool): Whether to suggest similar options on error
                (default: :code:`False`). Available in Python 3.14+.

            color (bool): Whether to use color in the help output (default: :code:`False`).
                Available in Python 3.14+.

        Returns:
            overload1 :code:`(NamespaceWrapper[NS])`: If namespace_type is provided,
                returns a configured NamespaceWrapper. Otherwise, returns a new
                :class:`NamespaceWithOptions` with updated options.

            overload2 :code:`(NamespaceWithOptions)`: If namespace_type is None,
                returns a new :class:`NamespaceWithOptions` with the combined options.
...
class GroupWithOptions:
    ...
    def __call__[NS](
        ...
        **options: Unpack[GroupOptions]
        ...
        Args:
            namespace_type (type[NS] | None): The type of the namespace class to be wrapped
                as an argument group. If :code:`None`, returns a new :class:`GroupWithOptions` with updated options.

            title (str | None): The title to display for this argument group in help output.
                If :code:`None`, no title is displayed for the group.
        ...
        Returns:
            overload1 :code:`(GroupWrapper[NS])`: If namespace_type is provided,
                returns a configured :class:`GroupWrapper` for immediate use. Otherwise, returns a new
                :class:`GroupWithOptions` with updated options.

            overload2 :code:`(GroupWithOptions)`: If namespace_type is None,
                returns a new :class:`GroupWithOptions` with the combined options.
...
class MutuallyExclusiveGroupWithOptions:
    ...
    def __call__[NS](
        ...
        **options: Unpack[MutuallyExclusiveGroupWrapperOptions]
        ...
        a new :class:`MutuallyExclusiveGroupWithOptions` instance with updated configuration.

        Args:
            namespace_type (type[NS] | None): The type of the namespace class to be wrapped
                as a mutually exclusive argument group. If None, returns a new
                :class:`MutuallyExclusiveGroupWithOptions` with updated options.
        ...
        Returns:
            overload1 :code:`(MutuallyExclusiveGroupWrapper[NS])`: If namespace_type is provided,
                returns a configured :class:`MutuallyExclusiveGroupWrapper` for immediate use.

            overload2 :code:`(MutuallyExclusiveGroupWithOptions)`: If namespace_type is None,
                returns a new :class:`MutuallyExclusiveGroupWithOptions` with updated options.
