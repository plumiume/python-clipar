"""Comprehensive type hints integration tests for optional arguments (v312)
...
class TestUnionTypes:
    """Test Union type hints (using | operator)"""
...
class TestUnionWithLiteral:
    ...
    def test_union_int_literal_str(self):
        """Test int | Literal[str values] union"""
        @namespace
        class Config:
            size: int | Literal["small", "large"] = "small"
    ...
    def test_union_str_literal_int(self):
        ...
        @namespace
        class Config:
            port: str | Literal[80, 443, 8080] = 80
    ...
    def test_union_type_order_int_before_str(self):
        """Test Union with int before str - int is tried first"""
        @namespace
        class Config:
            value: int | str = 42
    ...
    def test_union_type_order_str_before_int(self):
        """Test Union with str before int - str is tried first and always succeeds"""
        @namespace
        class Config:
            value: str | int = "default"
...
class TestOptionalTypes:
    """Test Optional type hints (Optional[T] = T | None)"""
...
class TestSequenceTypes:
    """Test sequence type hints (list, tuple)"""
...
class TestComplexUnionTypes:
    ...
    def test_union_multiple_literals(self):
        ...
        @namespace
        class Config:
            mode: Literal["a", "b"] | Literal["c", "d"] = "a"
    ...
    def test_union_int_str_literal(self):
        """Test complex union: int | str | Literal values"""
        @namespace
        class Config:
            value: int | str | Literal["auto", "max"] = "auto"
...
class TestMixedTypesInSequences:
    ...
    def test_list_union_elements(self):
        """Test list[int | str] - elements can be int or str"""
        @namespace
        class Config:
            mixed: list[int | str] = []
    ...
    def test_tuple_ellipsis_union(self):
        """Test tuple[int | str, ...] - variable length with union type"""
        @namespace
        class Config:
