"""Unit tests for clipar.v310.class_ast module"""
...
class TestClassAstHolder:
    ...
    @pytest.fixture
    def class_holder(self, sample_class: type[_T]):
        """ClassAstHolder instance for testing"""
        return ClassAstHolder(sample_class)

    def test_init_success(self, sample_class: type[_T]):
    ...
    def test_get_class_code_success(self, sample_class: type[_T]):
    ...
    def test_get_ast_tree_success(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_ast_tree_syntax_error(self, class_holder: ClassAstHolder[_T]):
    ...
    @patch('ast.parse')
    def test_get_ast_tree_unexpected_error(self, mock_parse: MagicMock, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_classdef_from_tree_success(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_classdef_from_tree_empty_body(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_classdef_from_tree_not_classdef(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_classdef_name_success(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_classdef_name_not_classdef(self, class_holder: ClassAstHolder[_T]):
        """Test handling of non-ClassDef nodes"""
    ...
    def test_get_annassign_target_name_success(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_annassign_target_name_not_annassign(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_annassign_target_name_complex_target(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_assign_target_name_success(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_assign_target_name_multiple_targets(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_assign_target_name_complex_target(self, class_holder: ClassAstHolder[_T]):
        """Test handling of complex target (not Name)"""
        target = ast.Attribute(value=ast.Name(id="self", ctx=ast.Load()), 
                              attr="var1", ctx=ast.Store())
        assign = ast.Assign(targets=[target], value=ast.Constant(value=1))
    ...
    def test_get_target_name_annassign(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_target_name_assign(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_target_name_none(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_str_constant_expr_success(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_str_constant_expr_not_expr(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_str_constant_expr_not_constant(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_str_constant_expr_not_string(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_assign_docs(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_orders(self, class_holder: ClassAstHolder[_T]):
    ...
    def test_get_assign_infos(self, class_holder: ClassAstHolder[_T]):
